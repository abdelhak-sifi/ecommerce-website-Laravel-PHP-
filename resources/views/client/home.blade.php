...
@section('content')
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">{{$slider->description_one}}</h1>
	              <h2 class="subheading mb-4">{{$slider->description_two}}</h2>
    ...
    <section class="ftco-section">
        ...
        <div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
					<a href="#" class="img-prod"><img class="img-fluid" src="storage/produit_images/{{$produit->produit_image}}" alt="Produit">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc">{{$produit->prix}}</span><span class="price-sale">{{$produit->prix}}</span></p>
		    					</div>
	    					</div>
